...
\newcommand{\mytitlepage}{template/title}
...
\newcommand{\myevaluator}{Prof. Dr. Ronny Seiger} %% your evaluator
\newcommand{\myhomestreet}{Ackerstrasse 26} %% your home street (with house number)
\newcommand{\myhometown}{Steckborn} %% your home town
\newcommand{\myhomepostalnumber}{8266} %% your postal number of home town
...
\include{theory}             %% this is a suggestion: you have to create this file on demand
\include{methodology}            %% this is a suggestion: you have to create this file on demand
\include{declaration}          %% this is a suggestion: you have to create this file on demand
